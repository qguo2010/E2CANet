...
class MSSpatialAttention(BaseModule):
    """
    ...
    def __init__(self,
        ...
        self.spatial_gating_unit = MSAttention(in_channels,
                                                 attention_kernel_sizes,
                                                 attention_kernel_paddings)
        self.proj_3 = GAttention(in_channels,reduction)
...
class CABlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.attn = MSSpatialAttention(channels, attention_kernel_sizes,
                                         attention_kernel_paddings,reduction, act_cfg)
